---
description: >-
  В документе описываются принципы и способы передачи в систему Retail Rocket пользовательского поведения на интернет магазине.
---

# API трекинга пользовательского поведения

Пользовательского поведение необходимо для многих продуктов Retail Rocket: товарные рекомендации, автоматизированые комуникационные кампании, метрики эфективности комуникаций и т.д.

## Общие концепции

Для передачи информации о поведении пользователей используется протокол HTTP.

Для каждого варианта действия пользователя существует соответствующий URL, обращение к которому приведет к сохранению этого действия в системе Retail Rocket.
...
Ниже описаны способы учета каждого из таких действий.

### Base URL

Базовый URL для каждого из описанных методов учета действий пользователя:
